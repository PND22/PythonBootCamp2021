...
translator = Translator() #สร้าง function แปลภาษา
      
GUI = Tk() #สร้างหน้าต่างหลัก
GUI.geometry('500x300') #กว้าง x สูง
GUI.title('โปรแกรมแปลภาษา by PND69')
...
# ------Result-----
v_result = StringVar() #นี่คือกล่องเก็บคำแปล
FONT2 = ('Angsana New' ,20)
R1 = ttk.Label (GUI,textvariable = v_result,font=FONT2,foreground='red')
R1.pack()
